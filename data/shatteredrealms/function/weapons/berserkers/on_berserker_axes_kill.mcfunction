...
scoreboard players operation @s sr_temp_kills = @s sr_berserker_axes_kills
...
execute if score @s sr_berserker_axes_kills matches 10 run scoreboard players set @s sr_has_any_mastery 1
execute if score @s sr_berserker_axes_kills matches 10 run playsound minecraft:entity.player.levelup master @s ~ ~ ~ 0.5 1.0
...
execute if score @s sr_berserker_axes_kills matches 25 run playsound minecraft:entity.player.levelup master @s ~ ~ ~ 0.5 1.1
...
execute if score @s sr_berserker_axes_kills matches 125 run playsound minecraft:entity.player.levelup master @s ~ ~ ~ 0.5 1.2
...
execute if score @s sr_berserker_axes_kills matches 750 run playsound minecraft:ui.toast.challenge_complete master @s ~ ~ ~ 0.7 1.0
