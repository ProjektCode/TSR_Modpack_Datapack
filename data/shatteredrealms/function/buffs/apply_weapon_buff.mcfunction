# ============================================
# Apply Weapon Buff Based on Current Weapon ID
# ============================================
# Called when weapon changes OR when same weapon needs refresh
# Clears old buff, then applies new one if applicable

# First, clear any existing weapon buff
function shatteredrealms:buffs/clear_weapon_buffs

# No weapon equipped (ID 0) - just clear, don't apply anything
execute if score @s sr_current_weapon_id matches 0 run return 0
