...
scoreboard players add @s tsra_double_axe_kills 1
...
execute if score @s tsra_double_axe_kills matches ..749 run advancement revoke @s only tsra:kills/rogues/triggers/double_axe_kill_trigger
